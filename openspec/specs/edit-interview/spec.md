...
This capability allows users to edit existing interview records for a candidate. It provides a backend PATCH endpoint and a frontend modal form to update interview details such as date, step, interviewer, score, notes, and result.
