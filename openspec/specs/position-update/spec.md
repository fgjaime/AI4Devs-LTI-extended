# Position Update Capability

## Purpose

This capability enables users to edit existing job positions. It covers the backend PATCH API endpoint, input validation, a frontend edit form, an edit button in the positions list, the frontend service method, and the routing required to support full position update functionality.
